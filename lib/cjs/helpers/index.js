...
})(MySQLFieldType || (exports.MySQLFieldType = MySQLFieldType = {}));
/**
 * @access private
...
const schema2SQL = (tableName, schema) => {
    ...
    if (lodash_1.default.some(schemaSQL, (curr) => !!curr.error)) {
        console.error("Schema error, please check Schema:", (_a = lodash_1.default.find(schemaSQL, (curr) => !!curr.error)) === null || _a === void 0 ? void 0 : _a.error);
        return false;
    }
