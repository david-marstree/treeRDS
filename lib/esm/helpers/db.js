 ...
 * @returns fieldObject
 */
export const intField = ({ name, defaultValue = 0, index, }) => field({ name, type: "int", defaultValue, index });
/**
 * @abstract define varchar field for table in database
 * @returns fieldObject
 */
export const varcharField = ({ name, defaultValue = null, index, }) => field({ name, type: "varchar", defaultValue, index });
/**
 * @abstract define longtext field for table in database
 * @param {*} name
 * @returns fieldObject
 */
export const longtextField = ({ name }) => field({ name, type: "longtext" });
/**
 * @abstract define double field for table in database
 * @returns fieldObject
 */
export const doubleField = ({ name, defaultValue = 0, index, }) => field({ name, type: "double", defaultValue, index });
/**
 * @access public
