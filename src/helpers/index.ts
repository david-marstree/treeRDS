 ...
 * @returns fieldObject
 */
export const primaryKey = (name: string): MySQLField =>
  field(name, MySQLFieldType.INT, true, 0, [name]);
...
export const intField = (
  ...
  defaultValue: any = 0,
  index: any,
): MySQLField => field(name, MySQLFieldType.INT, false, defaultValue, index);
...
export const varcharField = (
  ...
  field(name, MySQLFieldType.VARCHAR, false, defaultValue, index);
 ...
 * @returns fieldObject
 */
export const longtextField = (name: string) =>
  field(name, MySQLFieldType.LONGTEXT, false, null, null);
...
export const doubleField = (
  ...
  defaultValue: any = 0,
  index: any = null,
): MySQLField => field(name, MySQLFieldType.DOUBLE, false, defaultValue, index);
